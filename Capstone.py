...
employees_database = [{"ID": 1000, "First Name" : "Krisa", "Last Name" : "Wahyu", "Position" : "Student", "Department" : "Data Science", "Salary" : 500, "Startworking" : date(2024,10,28),"Status": "Active"}] # List to store employee data
